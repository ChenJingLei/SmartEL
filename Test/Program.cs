...
namespace Test
{
    ...
    //        {
    //            ClassRoomPlanControl control = new ClassRoomPlanControl();
    //            int i = control.GetStatus("11101", DateTime.Now.ToString("yyyy-MM-dd"), 5);
    //            //            control.getClassPlan();
    //            //
    //            //            control.SetStatisticsData(new Statistics("123", DateTime.Now, 11.1, 11.2));
